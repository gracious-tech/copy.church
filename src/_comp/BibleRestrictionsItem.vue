...
p These restrictions are based on what the translation owner has declared is allowed, however they do not nullify #[a(href='/copyright/#fair-use') existing rights to fair use] which may be slightly more permissive in some cases.
p You also may be able to ask the copyright owner for additional permissions. Though, <a href='/objections/#just-ask-for-permission'>there is no guarantee</a> your request will be accepted.
p
...
tr
    ...
    // Top of table is a heading so no border
    &:first-child
...
th
    ...
    div
        ...
        :deep(span)
            ...
            &.mixed
                background-color: hsla(30, 50%, 50%, 0.8)
