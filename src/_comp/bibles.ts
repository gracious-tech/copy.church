...
const bibles_raw = {
    ...
    leb: {
        ...
        can: {
            ...
            use_quote_openly: true,
            use_commercially: false,
            audio: true,  // Not explicit in actual license but is explained in FAQ
            translate: false,
            modify: false,
            access_source: false,
        },
    ...
    rsv: {
        ...
        type: "Dynamic",
        source: "Alexandrian",
        info: 'https://en.wikipedia.org/wiki/Revised_Standard_Version',
        license: 'https://www.friendshippress.org/pages/nrsvue-quick-faq',
        read: 'https://www.bible.com/bible/2020/JHN.1.RSV',
        credit: "",
        can: {
            read_for_free: true,
            read_anonymously: false,
